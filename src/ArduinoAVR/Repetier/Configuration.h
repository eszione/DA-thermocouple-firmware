...
#define EXT0_TEMPSENSOR_PIN MAX6675_SS
...
/** P-gain.  Overridden if EEPROM activated. */
#define EXT1_PID_P   4.11
/** I-gain.  Overridden if EEPROM activated.
*/
#define EXT1_PID_I   0.85
/** D-gain.  Overridden if EEPROM activated.*/
#define EXT1_PID_D 4.80
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
...
// If defined, the MAX6675 SPI port is manually "bit-banged" rather than using hardware SPI
#define BITBANG_MAX6675 
...
#define UI_PRINTER_NAME "New Zealand"
#define UI_PRINTER_COMPANY "Diamond Age"
